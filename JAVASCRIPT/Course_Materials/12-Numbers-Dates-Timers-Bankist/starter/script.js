...
// Date Function
const formatTransactionDate = function (date, loc) {
...
const displayMovements = function (acc, sort = false) {
	...
	movs.forEach(function (mov, i) {
		...
		const formattedTrans = formatCur(mov, acc.locale, acc.currency);
...
// Experimenting with the INT API
